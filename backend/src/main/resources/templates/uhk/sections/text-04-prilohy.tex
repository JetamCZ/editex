...
\begin{figure*}[h]\centering
  \centering
  \includegraphics[width=\linewidth,height=1.7in]{img/uhk.jpg}\\[1pt]
  \includegraphics[width=0.24\linewidth]{img/uhk.jpg}\hfill
  \includegraphics[width=0.24\linewidth]{img/uhk.jpg}\hfill
  \includegraphics[width=0.24\linewidth]{img/uhk.jpg}\hfill
  \includegraphics[width=0.24\linewidth]{img/uhk.jpg}
...
\begin{figure}[hbt]
	\centering
	\includegraphics[width=0.3\textwidth]{img/uhk.jpg}
